...
5. 把音频发送到 ASR。支持 `openai`、`doubao`、`sensevoice`、本地 `whisper.cpp`、`voxtype`，以及 `qwen3-asr-vllm`。
...
- 支持的 ASR provider：`openai`、`doubao`、`whispercpp`、`sensevoice`、`voxtype`、`qwen3-asr-vllm`
